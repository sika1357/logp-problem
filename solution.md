...
Step 4: Calculate void time from duplicate void-marker injections: t_0 = 0.9450 min. Average duplicate measurements.
Step 5: Calculate k' = tR/t_0 - 1, regress log_1_0(k') vs. organic fraction, and use the intercept as log_1_0(k'w).
Calibration:
log_1_0(k'w) = 0.7900 x log P - 0.5501
Unknown: log_1_0(k'w) = 3.0964
Final answer:
